    ...
    const fetchSettings = async()=>{
      ...
      try{
        ...
        if(settingsDoc.exists()){
          ...
          const settings = {
            companyName: data.companyName || 'Eleman Shoes',
            logoUrl: data.logoUrl || '/okp.jpeg'
          };
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/"
              className="text-leather-dark hover:text-leather-brown transition-colors font-medium"
            >
              {t('home')}
            </Link>
