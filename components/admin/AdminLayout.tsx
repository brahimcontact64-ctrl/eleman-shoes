  ...
  return (
    ...
    <div className="min-h-screen bg-leather-beige">
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-leather-dark shadow-md min-h-screen">
          ...
          <div className="p-4 border-b border-leather-brown/30">
            ...
            <Link href="/admin/dashboard">
              ...
              <h1 className="text-xl font-bold text-leather-beige">
                Admin Panel
              </h1>
            ...
            {user && (
              <p className="text-sm text-leather-light/70 mt-1">
                {user.displayName}
              </p>
            )}
                  ...
                  <li key={item.href}>
                    ...
                    <Link
                      ...
                      className={
                        ...
                        (isActive
                          ? 'bg-leather-brown text-white'
                          : 'text-leather-beige hover:bg-leather-brown/20')
                      }
                    >
          ...
          <div className="p-4 border-t border-leather-brown/30 absolute bottom-0 w-64">
            ...
            <Button
              variant="outline"
              className="w-full border-leather-light/30 text-leather-beige hover:bg-leather-brown hover:text-white"
        ...
        <main className="flex-1 p-8 bg-leather-beige">
