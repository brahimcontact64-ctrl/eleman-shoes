          ...
          <div className="relative container mx-auto px-4 h-full flex items-center">
            <div className="max-w-2xl text-white">
              ...
              >
                <Button
                  size="lg"
                  className="bg-leather-coffee hover:bg-leather-dark text-white text-lg px-10 py-6 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                >
          ...
          <div className="container mx-auto px-4">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-xl text-leather-gray">Aucun produit disponible pour le moment</p>
              </div>
            )}
        ...
        <section className="py-20 bg-gradient-to-br from-leather-brown to-leather-coffee text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/catalog">
                <Button size="lg" variant="secondary" className="w-full sm:w-auto text-lg px-8 bg-white text-leather-dark hover:bg-leather-beige">
                  Parcourir le Catalogue
                </Button>
              </Link>
              <Link href="/contact">
                <Button size="lg" variant="outline" className="w-full sm:w-auto text-lg px-8 bg-transparent border-2 border-white text-white hover:bg-white hover:text-leather-coffee">
                  Nous Contacter
                </Button>
              </Link>
            </div>
