        ...
        <section className="relative h-[520px] sm:h-[600px] md:h-[700px] overflow-hidden">
          <div className="absolute inset-0">
            <img
              ...
              "
            />
            <div className="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-r from-black/60 via-black/40 to-transparent" />
          </div>

          <div className="relative container mx-auto px-4 h-full flex items-end sm:items-center pb-12 sm:pb-0">
            <div className="max-w-2xl text-white">
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif font-bold mb-4 sm:mb-6 leading-tight drop-shadow-lg">
                {settings.heroTitle}
              </h1>

              <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 drop-shadow-md font-light">
              ...
              >
                <Button
                  size="lg"
                  className="
                    bg-leather-coffee hover:bg-leather-dark
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[ 
                ...
                <Card key={title} className="border-leather-light/30 bg-leather-beige/50 hover:shadow-lg">
        ...
        <section className="py-16 bg-leather-beige">
          <div className="container mx-auto px-4">
            ...
            {loading ? (
              ...
              <p className="text-center text-xl text-leather-gray py-12">
        ...
        <section className="py-20 bg-gradient-to-br from-leather-brown to-leather-coffee text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/catalog">
                <Button size="lg" variant="secondary" className="bg-white text-leather-dark">
